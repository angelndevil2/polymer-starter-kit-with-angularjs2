...
var spawnChild = require('child_process');

var spawn = spawnChild.spawnSync;
...
gulp.task('copy', ['ts-compile'], function() {
  var app = gulp.src([
    'app/*',
    '!app/test',
    '!app/elements',
  ...
  return merge(app, bower, ts, rxjs, umds, mem, etc)
    .pipe($.size({
      title: 'copy'
    }));
});

// Copy angular2 to tmp
gulp.task('copy-angular2-tmp', function() {
